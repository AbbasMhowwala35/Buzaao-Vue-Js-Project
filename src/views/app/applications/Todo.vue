        ...
        <div class="p-4" >
          ...
          <ul class="list-unstyled mb-4">
            <li class="nav-item"><a href="#" >
                 <i class="simple-icon-reload" /><span class="d-inline-block">{{$t('todo.all-tasks')}}</span> <span class="float-right" v-if="isLoad">{{items.length}}</span>
              </a></li>
            <li class="nav-item"><a href="#" >
                 <i class="simple-icon-refresh" /><span class="d-inline-block">{{$t('todo.pending-tasks')}}</span> <span class="float-right" v-if="isLoad">{{items.filter(x => x.status === "PENDING").length}}</span>
              </a></li>
            <li class="nav-item"><a href="#" >
                 <i class="simple-icon-check" /><span class="d-inline-block">{{$t('todo.completed-tasks')}}</span> <span class="float-right" v-if="isLoad">{{items.filter(x => x.status === "COMPLETED").length}}</span>
              </a></li>
          </ul>
