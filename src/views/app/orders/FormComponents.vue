            ...
            <b-row>
              <b-colxx xxs="12" md="6">
                <vue-autosuggest
                  ...
                  :limit="6"
                  :input-props="{id:'autosuggest__input', class:'form-control', onInputChange: this.onAutoSuggestInputChange, placeholder:$t('form-components.type-a-cake')}"
                />
              </b-colxx>
            </b-row>
          </b-form>
            ...
            <b-row class="mb-5">
              ...
              <b-colxx xxs="12">
                <v-date-picker
                  ...
                  :input-props="{ class: 'form-control', placeholder: $t('form-components.disabled-dates')}"
                ></v-date-picker>
              </b-colxx>
            </b-row>
          </b-form>
            ...
            <b-row>
              <b-colxx xxs="6">
                <b-row>
                  ...
                  <b-colxx xxs="12">
                    <switches
                      v-model="switches.primaryInverse"
                      theme="custom"
              ...
              <b-colxx xxs="6">
                <b-row>
                  ...
                  <b-colxx xxs="12">
                    <switches
                      v-model="switches.secondaryInverse"
                      theme="custom"
